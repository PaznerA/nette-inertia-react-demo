Nette Web Project with Inertia.js and React - WIP
=================

This repo is created from [Nette web project](https://github.com/nette/web-project) as an example, how to use frontend components with nette backend.
